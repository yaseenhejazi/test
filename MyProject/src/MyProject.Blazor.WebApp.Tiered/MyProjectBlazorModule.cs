...
using MyProject.Blazor.WebApp.Tiered.Client;
using MyProject.Blazor.WebApp.Tiered.Client.Menus;
using MyProject.Blazor.WebApp.Tiered.Components;
using MyProject.Blazor.WebApp.Tiered.Menus;
...
public class MyProjectBlazorModule : AbpModule
{
        ...
        Configure<AbpBundlingOptions>(options =>
        {
            ...
            options.StyleBundles.Configure(
                ...
                bundle =>
                {
                    ...
                    bundle.AddFiles(new BundleFile("/MyProject.Blazor.WebApp.Tiered.Client.styles.css", true));
                }
            );
        });
    }
    ...
    private void ConfigureRouter(ServiceConfigurationContext context)
    {
        Configure<AbpRouterOptions>(options =>
        {
            ...
            options.AdditionalAssemblies.Add(typeof(MyProjectBlazorClientModule).Assembly);
        });
    }
