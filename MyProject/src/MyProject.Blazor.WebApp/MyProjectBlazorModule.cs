...
using MyProject.Blazor.WebApp.Client;
using MyProject.Blazor.WebApp.Client.Menus;
using MyProject.Blazor.WebApp.Components;
...
public class MyProjectBlazorModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ...
        if (!hostingEnvironment.IsDevelopment())
        {
            ...
            {
                serverBuilder.AddProductionEncryptionAndSigningCertificate("openiddict.pfx", "5c134e3c-1842-4af0-8e2f-da1a00344840");
            });
        }
        ...
        Configure<AbpBundlingOptions>(options =>
        {
            ...
            options.StyleBundles.Configure(
                ...
                bundle =>
                {
                    ...
                    bundle.AddFiles(new BundleFile("/MyProject.Blazor.WebApp.Client.styles.css", true));
                }
            );
        });
    }
