...
using MyProject.Blazor.WebApp.Client.Menus;
...
public class MyProjectBlazorClientModule : AbpModule
{
    ...
    private void ConfigureRouter(ServiceConfigurationContext context)
    {
        ...
        {
            options.AppAssembly = typeof(MyProjectBlazorClientModule).Assembly;
    ...
    private void ConfigureAutoMapper(ServiceConfigurationContext context)
    {
        ...
        {
            options.AddMaps<MyProjectBlazorClientModule>();
        });
    }
}
